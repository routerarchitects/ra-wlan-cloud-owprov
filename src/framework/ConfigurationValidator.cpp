...
static const std::vector<std::string> GitJSONSchemaURLs = {
	...
	{"https://raw.githubusercontent.com/Telecominfraproject/olg-ucentral-schema/ra_proposal/ucentral.schema.json"}
};

static std::string DefaultOLGSchema = R"OLGSCHEMA(
{
...
namespace OpenWifi {
	...
	void ConfigurationValidator::Init() {
		...
		try {
			for(auto Type : {ConfigurationType::AP, ConfigurationType::SWITCH, ConfigurationType::OLG}) {
				auto GitURI =
